...
//		ArbNum arbNum = new ArbNum("-42");
//		ArbNum arbNum2 = new ArbNum("7");
//		
//		ArbNum newNum = arbNum.add(arbNum2);
//		
//		System.out.println(arbNum);
//		System.out.println(arbNum2);
//		System.out.println(newNum);
//
//		ArbNum arbNum = new ArbNum("374");
//		ArbNum arbNum2 = new ArbNum("375");
//		
//		ArbNum arbNum3 = arbNum.div(arbNum2);
//		
//		System.out.println(arbNum3);
//		
//		
//		Math calc1 = new Math();
//		ArbNum A = new ArbNum("-6");
//		ArbNum B = new ArbNum("2");
//		ArbNum result = calc1.tan(calc1.pi.div(calc1.c[2]));
